...
class Management:
    def __init__(self, root):
        ...
        self.window.maxsize(width=1366,  height=768)
        self.window.minsize(width=1366,  height=768)
        ...
        self.frame_1.place(x=0, y=50, width=150,height = 600)

        # Right Frame
        self.frame_2 = Frame(self.window, bg = self.color_2)
        self.frame_2.place(x=150,y=50,width=940, height=600)

        # top Frame
        self.frame_3 = Frame(self.window, bg = self.color_7)
        self.frame_3.place(x=0,y=0,width=1090, height=60)

        # Buttons
        self.add_bt = Button(self.frame_1, text='SIGN UP', font=(self.font_1, 12), bd=4, command=self.AddStudent, 
                      bg=self.color_6,fg=self.color_3).place(x=20,y=50,width=90)
        self.view_bt = Button(self.frame_1, text='LOG IN', font=(self.font_1, 12), bd=4, command=self.GetContact_View,
                      cursor="hand2", bg=self.color_6,fg=self.color_3).place(x=20,y=100,width=90)
        self.update_bt = Button(self.frame_1, text='UPDATE', font=(self.font_1, 12), bd=4, command=self.GetContact_Update, cursor="hand2",
                      bg=self.color_6,fg=self.color_3).place(x=20,y=150,width=90)
        self.delete_bt = Button(self.frame_1, text='DELETE', font=(self.font_1, 12), bd=4, command=self.GetContact_Delete,cursor="hand2",
                      bg=self.color_6,fg=self.color_3).place(x=20,y=200,width=90)
        self.clear_bt = Button(self.frame_1, text='CLEAR', font=(self.font_1, 12), bd=4, command=self.ClearScreen, cursor="hand2",
                      bg=self.color_6,fg=self.color_3).place(x=20,y=250,width=90)
        
        self.date_bt = Button(self.frame_1, text='DATE', font=(self.font_1, 12), bd=4, command=self.date,cursor="hand2", bg=self.color_6,
                      fg=self.color_3).place(x=20,y=300,width=90)
        self.exit_bt = Button(self.frame_1, text='EXIT', font=(self.font_1, 12), bd=4, command=self.Exit,cursor="hand2", bg=self.color_6,
                      fg=self.color_3).place(x=20,y=350,width=90)
    ...
    def AddStudent(self):
        ...
        self.name = Label(self.frame_2, text="First Name:", font=(self.font_2, 18, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=20)
        self.name_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.name_entry.place(x=100,y=50, width=200)

        self.surname = Label(self.frame_2, text="Last Name:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=20)
        self.surname_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.surname_entry.place(x=530,y=50, width=200)

        self.course = Label(self.frame_2, text="Course:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=80)
        self.course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.course_entry.place(x=100,y=110, width=200)

        self.Course_Package = Label(self.frame_2, text="Course Package:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=80)
        ...
        self.date = Label(self.frame_2, text="Date:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=140)
        self.date_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.date_entry.place(x=100,y=170, width=200)

        self.age = Label(self.frame_2, text="Age:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=140)
        self.age_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.age_entry.place(x=530,y=170, width=200)

        self.gender = Label(self.frame_2, text="Gender:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=200)
        self.gender_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.gender_entry.place(x=100,y=230, width=200)

        self.birthday = Label(self.frame_2, text="Birthday:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=200)
        self.birthday_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.birthday_entry.place(x=530,y=230, width=200)

        self.contact = Label(self.frame_2, text="Contact:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=260)
        self.contact_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.contact_entry.place(x=100,y=290, width=200)

        self.email = Label(self.frame_2, text="Email:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=260)
        self.email_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.email_entry.place(x=530,y=290, width=200)

        self.Current_Course = Label(self.frame_2, text="Current Course:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=320)
        ...
        self.Pending_Course = Label(self.frame_2, text="Pending Course:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=320)
        ...
        self.Completed_Course = Label(self.frame_2, text="Completed Course:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=380)
        ...
        self.Total_Fees = Label(self.frame_2, text="Total Fees:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=380)
        ...
        self.Paid_Fees = Label(self.frame_2, text="Paid Fees:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=100,y=440)
        self.Paid_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Paid_Fees_entry.place(x=100,y=470, width=200)

        self.Balance_Fees = Label(self.frame_2, text="Balance Fees:", font=(self.font_2, 15, "italic"), bg=self.color_2, fg=self.color_5).place(x=530,y=440)
    ...
    def GetContact_View(self):
        ...
        self.getInfo = Label(self.frame_2, text="Enter Email", font=(self.font_2, 18, "bold"), bg=self.color_2).place(x=380,y=170)
    ...
    def CheckContact_View(self):
       if self.getInfo_entry.get() == "":
           ...
           try:
               ...
               curs.execute("select * from students_registers where contact=%s", self.getInfo_entry.get())
               row=curs.fetchone()
               if row == None:
    ...
    def Checkdate_View(self):
        if self.getInfo_entry.get() == "":
            ...
            try:
                connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
                curs = connection.cursor()
                curs.execute("select * from students_registers where date=%s", self.getInfo_entry.get())
                row=curs.fetchone()
        ...
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                if row == None:
                    ...
                    curs.execute("delete from students_register where contact=%s", self.getInfo_entry.get())
                    connection.commit()
    ...
    def GetUpdateDetails(self, row):
        ...
        self.birthday = Label(self.frame_2, text="Birthday", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=530,y=200)
        self.birthday_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.birthday_entry.insert(0, row[7])
        self.birthday_entry.place(x=530,y=230, width=200,height=22)
    ...
    def ShowDetails(self, row):
        ...
        birthday = Label(self.frame_2, text="Birthday", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=530,y=200)
        birthday_data = Label(self.frame_2, text=row[7], font=(self.font_1, 10)).place(x=530, y=230)
    ...
    def UpdateDetails(self, row):
        ...
        self.date_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birthday_entry.get() == "" or self.email_entry.get() == "" or
            ...
            try:
                connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
                curs = connection.cursor()
                curs.execute("select * from student_registers where contact=%s", row[8])
                row=curs.fetchone()

                if row==None:
                    messagebox.showerror("Error!","The contact number doesn't exists",parent=self.window)
                else:
                    curs.execute("update student_register set f_name=%s,l_name=%s, course=%s, course_Package=%s, date=%s, age=%s, gender=%s, birthday=%s,email=%s,current_course=%s,pending_course=%s,completed_course=%s,total_fees=%s,paid_fees=%s,balance_fees=%s where contact=%s",
                                        (
                                            self.name_entry.get(),
    ...
    def Submit(self):
        if (self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.Course_Package_entry.get() == "" or 
        self.date_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birthday_entry.get() == "" or self.contact_entry.get() == "" 
        or self.email_entry.get() == "" or self.Current_Course_entry.get()== "" or self.Pending_Course_entry.get() == "" or  self.Completed_Course_entry.get()== "" or self.Total_Fees_entry.get()== "" or
            ...
            try:
                connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
                curs = connection.cursor()
                curs.execute("select * from students_registers where contact=%s", self.contact_entry.get())
                row=curs.fetchone()

                if row!=None:
                    messagebox.showerror("Error!","The contact number is already exists, please try again with another number",parent=self.window)
                else:
                    curs.execute("insert into students_registers (f_name,l_name,course,course_package,date,age,gender,birthday,contact,email,current_course,pending_course,completed_course,Total_fees,paid_fees,balance_fees)values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                                        (
                                            self.name_entry.get(),
                                            self.surname_entry.get(),
                                            self.course_entry.get(),
